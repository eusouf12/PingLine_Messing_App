...
class AppColors {
  ...
  static const Color primary = Color.fromARGB(255, 14, 21, 39);
  static const Color loading = Color.fromARGB(255, 0, 224, 183);
  ...
  static const Color red2 = Color(0xff490f0f);
  static const Color navbar = Color(0xff212121);
  static const Color navbar2 = Color(0xff141414);
